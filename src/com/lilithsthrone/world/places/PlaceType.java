...
import com.lilithsthrone.game.dialogue.places.illeton.IlletonPlaces;
...
public class PlaceType {
	...
	public static final AbstractPlaceType ILLETON_GATE = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Illeton Gate",
			"The starting point for those wishing to gain entry to Paradise.",
			"illeton/gate",
			PresetColour.BASE_PINK_DEEP,
			IlletonPlaces.ILLETON_GATE,
			Darkness.ALWAYS_LIGHT,
			null, "at Illeton's fabled gate") {
		@Override
		public List<Population> getPopulation() {
			List<Population> pop = new ArrayList<>();
	...
	//TODO: Add Illeton Encounters, fix IlletonPlaces descriptors
	public static final AbstractPlaceType ILLETON_MAIN_ROAD = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Illeton Main Road",
			"The main road runs right through the center of Illeton, from its large gate to Paradise.",
			null,
			PresetColour.BASE_PINK_LIGHT,
			IlletonPlaces.BOULEVARD,
			Darkness.ALWAYS_LIGHT, Encounter.DOMINION_BOULEVARD, "in the streets of Illeton") {
	...
	public static final AbstractPlaceType ILLETON_MARKET = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Market",
			"A bustling market full of a variety of stores. You can't round a corner without seeing at least a dozen advertisements for different stores.",
			null,
			PresetColour.BASE_PINK_LIGHT,
			IlletonPlaces.BOULEVARD,
			Darkness.ALWAYS_LIGHT, Encounter.DOMINION_BOULEVARD, "in the streets of Illeton") {
	...
	public static final AbstractPlaceType ILLETON_ALLEYS = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Alleyways",
			"The alleys of Illeton where the shadier deals of the market take place.",
			"dominion/alleysIcon",
			PresetColour.BASE_BLACK,
			IlletonPlaces.BACK_ALLEYS,
			Darkness.DAYLIGHT, Encounter.DOMINION_ALLEY, "in the alleys of Illeton"
	).initDangerous();

	public static final AbstractPlaceType ILLETON_DARK_ALLEYS = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Alleyways",
			"The alleys of Illeton where the shadier deals of the market take place.",
			"dominion/alleysIcon",
	...
	public static final AbstractPlaceType ILLETON_SLUMS_GATE = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Slums Gate",
			"The entry to the underside of Illeton.",
			"illeton/gate",
			PresetColour.BASE_PINK_DEEP,
			IlletonPlaces.ILLETON_GATE,
			Darkness.ALWAYS_LIGHT,
			null, "at the entrance to Illeton's slums") {
	};

	public static final AbstractPlaceType ILLETON_SLUMS = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Alleyways",
			"The alleys of Illeton where the shadier deals of the market take place.",
			"illeton/slums",
			PresetColour.BASE_BLACK,
			IlletonPlaces.SLUMS,
			Darkness.DAYLIGHT, Encounter.DOMINION_ALLEY, "in the slums of Illeton"
	).initDangerous();

	public static final AbstractPlaceType ILLETON_DEEP_SLUMS = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Deep Slums",
			"Deep within the slums of Illeton, all you hear are hushed voices and the occasional shifty figure hurrying along.",
			"illeton/deepSlums",
			PresetColour.BASE_RED_DARK,
			IlletonPlaces.DEEP_SLUMS,
			Darkness.DAYLIGHT, Encounter.DOMINION_ALLEY, "deep within the slums of Illeton"
	).initDangerous();

	public static final AbstractPlaceType ILLETON_HIDDEN_SLUMS = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Hidden Slums",
			"The hidden slums are shrouded in perpetual darkness, rumored to ensnare any foolhardy enough to enter.",
			"illeton/hiddenSlums",
			PresetColour.BASE_PITCH_BLACK,
			IlletonPlaces.HIDDEN_SLUMS,
			Darkness.DAYLIGHT, Encounter.DOMINION_ALLEY, "within the hidden slums of Illeton"
	).initDangerous();

	public static final AbstractPlaceType ILLETON_PARADISE_GATE = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Paradise Gate",
			...
			IlletonPlaces.ILLETON_GATE,
			Darkness.ALWAYS_LIGHT,
			null, "at the entrance to Paradise") {
	};

	public static final AbstractPlaceType ILLETON_PARADISE_RESIDENTIAL = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Paradise - Residential",
			"Paradise's residential district is home to advanced arcane magic and futuristic technology.",
			null,
			PresetColour.BASE_PINK_LIGHT,
			IlletonPlaces.BOULEVARD,
			Darkness.ALWAYS_LIGHT, Encounter.DOMINION_BOULEVARD, "in the streets of Paradise") {
	...
	public static final AbstractPlaceType ILLETON_PARADISE_RESEARCH = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Paradise - Research",
			"The research district is full of factories and laboratories, all pursuing the advancement of Paradise.",
			null,
			PresetColour.BASE_PINK_LIGHT,
			IlletonPlaces.BOULEVARD,
			Darkness.ALWAYS_LIGHT, Encounter.DOMINION_BOULEVARD, "in the streets of Paradise") {
	...
	public static final AbstractPlaceType ILLETON_EDEN = new AbstractPlaceType(
			WorldRegion.ILLETON,
			"Eden",
			"Eden is home to Paradise's overseers, those who even the utopia's aristocrats would call supreme.",
			"illeton/gate",
			PresetColour.BASE_PINK_DEEP,
			IlletonPlaces.ILLETON_GATE,
			Darkness.ALWAYS_LIGHT,
			null, "at the entrance to Eden.") {
	};
	...
	public static final AbstractGlobalPlaceType WORLD_MAP_ILLETON = new AbstractGlobalPlaceType(
			WorldRegion.ILLETON,
			"Illeton",
			"A city where the affluent thrive and the downtrodden are left to rot.",
			"global/illeton",
			PresetColour.BASE_PURPLE,
			new Colour(Util.newColour(0x826B85)),
			GlobalFoloiFields.ILLETON_EXTERIOR,
			null, "in the outskirts of Dominion") {
		@Override
		public AbstractWorldType getGlobalLinkedWorldType() {
			return WorldType.ILLETON;
		}
	};
