...
public class WorldType {
	...
	public static AbstractWorldType WORLD_MAP = new AbstractWorldType(WorldRegion.MISC,
			...
			TeleportPermissions.BOTH, "/com/lilithsthrone/res/map/global/world_map.png", null, null, Util.newHashMapOfValues(
					...
					new Value<>(new Color(0x215963), PlaceType.WORLD_MAP_ILLETON))) {
		@Override
	...
	//TODO: Add more place types for Illeton
	public static AbstractWorldType ILLETON = new AbstractWorldType(WorldRegion.ILLETON,
			"Illeton",
			PresetColour.BASE_PURPLE,
			1,
			true,
			true,
			TeleportPermissions.BOTH, "/com/lilithsthrone/res/map/illeton/illeton.png", PlaceType.WORLD_MAP_ILLETON, PlaceType.ILLETON_GATE, Util.newHashMapOfValues(
			new Value<>(new Color(0xffffff), PlaceType.GENERIC_IMPASSABLE),
			new Value<>(new Color(0x808080), PlaceType.ILLETON_MAIN_ROAD),
			new Value<>(new Color(0x222034), PlaceType.ILLETON_GATE),

			new Value<>(new Color(0xa4a4a4), PlaceType.ILLETON_MARKET),
			new Value<>(new Color(0xff6b00), PlaceType.ILLETON_ALLEYS),
			new Value<>(new Color(0x863800), PlaceType.ILLETON_DARK_ALLEYS),

			new Value<>(new Color(0xff3a3a), PlaceType.ILLETON_SLUMS_GATE),
			new Value<>(new Color(0xc10000), PlaceType.ILLETON_SLUMS),
			new Value<>(new Color(0x5b0000), PlaceType.ILLETON_DEEP_SLUMS),
			new Value<>(new Color(0x2a0000), PlaceType.ILLETON_HIDDEN_SLUMS),

			new Value<>(new Color(0x0027ff), PlaceType.ILLETON_PARADISE_GATE),
			new Value<>(new Color(0x0080ff), PlaceType.ILLETON_PARADISE_RESIDENTIAL),
			new Value<>(new Color(0xffd700), PlaceType.ILLETON_PARADISE_RESEARCH),
			new Value<>(new Color(0xc9af00), PlaceType.ILLETON_EDEN))) {
	};
