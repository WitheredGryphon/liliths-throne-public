...
public enum Quest {
	...
	ILLETON_PROLOGUE(QuestType.MAIN, 25, 100) {
		@Override
		public String getName() {
			return "A pass for Illeton.";
		}

		@Override
		public String getDescription() {
			return "The guards refused to let you enter Illeton without a pass. Maybe Lilaya knows someone who could get you in?";
		}
