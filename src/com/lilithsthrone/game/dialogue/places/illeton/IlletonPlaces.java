package com.lilithsthrone.game.dialogue.places.illeton;
 ...
 * @since 0.3.19
 * @version 0.3.19
 * @author WitheredGryphon
 */
public class IlletonPlaces {
...
//				}
	...
	public static final DialogueNode DARK_ALLEYS = new DialogueNode("", "", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/illeton/illetonPlaces", "DARK_ALLEYS", new ArrayList<GameCharacter>(Main.game.getNonCompanionCharactersPresent())));
	...
	public static final DialogueNode SLUMS = new DialogueNode("Slums", "", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/illeton/illetonPlaces", "SLUMS", new ArrayList<GameCharacter>(Main.game.getNonCompanionCharactersPresent())));
	...
	public static final DialogueNode DEEP_SLUMS = new DialogueNode("Deep Slums", "", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/illeton/illetonPlaces", "DEEP_SLUMS", new ArrayList<GameCharacter>(Main.game.getNonCompanionCharactersPresent())));
	...
	public static final DialogueNode HIDDEN_SLUMS = new DialogueNode("Hidden Slums", "", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/illeton/illetonPlaces", "HIDDEN_SLUMS", new ArrayList<GameCharacter>(Main.game.getNonCompanionCharactersPresent())));
	...
	public static final DialogueNode ILLETON_GATE = new DialogueNode("Illeton Gate", ".", true) {

		@Override
		public boolean isTravelDisabled() {
			return !Main.game.getPlayer().isQuestProgressGreaterThan(QuestLine.MAIN_ILLETON, Quest.ILLETON_PROLOGUE);
		}
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append("<p>"
						+ "You stand in front of Illeton's towering gate. The sheer size of the concrete walls would snuff any hope of vagabonds scaling its height."
						+ " Along the ramparts, fierce turrets are evenly distributed down its length, surely to keep out those capable of flight as well."
					+ "</p>"
					+ "<p>"
						+ "A long line of various races are gathered in front of the gate as imposing guards check their credentials."
						+ " One thing's clear. There's no way you're getting in without a pass."
					+ "</p>");
			...
			if(Main.game.getCurrentWeather()==Weather.MAGIC_STORM) {
				UtilText.nodeContentSB.append(
						"<p>"
							...
							+ "You're alone in front of Illeton's mighty gate."
							+ " Far above you, the turrets along the wall slowly pivot from left to right, watching for any signs of intruders."
							+ " It'd be best to try again later when the gate has re-opened."
						+ "</p>");
			}
		...
		public Response getResponse(int responseTab, int index) {
			if(index == 1) {
				if(Main.game.getCurrentWeather()==Weather.MAGIC_STORM) {
					return new Response(
							"Gate", "The gates are closed, and no one's here due to the storm...", null);
					
				} else {
					return new Response(
							"Guards",
							"Introduce yourself to the guards...", ILLETON_GATE_GUARDS){
								@Override
								public void effects() {
				...
				return new ResponseEffectsOnly("Leave", "Turn away from the gate and continue on your journey...") {
					@Override
					public void effects() {
	...
	public static final DialogueNode ILLETON_GATE_GUARDS = new DialogueNode("Illeton Gate", ".", false, true) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append("<p>"
					+ "You decide to introduce yourself to the guards..."
					+ "</p>");
		...
		@Override
		public Response getResponse(int responseTab, int index) {
			return ILLETON_GATE.getResponse(responseTab, index);
		}
	};

		public static final DialogueNode ILLETON_LEAVE_GATE = new DialogueNode("Illeton Gate", ".", false, true) {
			...
			public String getContent() {
				...
				UtilText.nodeContentSB.append("<p>"
						+ "You turn away from the gargantuan gate and continue on your journey."
						+ "</p>");
